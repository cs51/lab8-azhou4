...
(* .. *)
let bryan = WEvent.add_listener newswire fakeNewsNetwork;;
let karen = WEvent.add_listener newswire buzzFake;;
...
WEvent.remove_listener newswire bryan;;
WEvent.remove_listener newswire karen;;
